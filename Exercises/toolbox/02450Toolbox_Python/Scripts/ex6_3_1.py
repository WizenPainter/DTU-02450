...
import sys
sys.path.insert(0, '02450/Exercises/toolbox/02450Toolbox_Python/')
...
mat_data = loadmat('02450/Exercises/toolbox/02450Toolbox_Python/Data/synth1.mat') # <-- change the number to change dataset
X = mat_data['X']
